...
import type { NftData } from "../../../types/appTypes.ts";
...
export async function generateScannerOutput(metadata: NftData) {
    const messages: any[] = [
        {
            role: "system",
        ...
        },
        {
            ...
            GENERATING SCANNER OUTPUT FOR ${metadata.Level}${" "}${metadata.Power1}${" "}${metadata.Power2}${" "}${metadata.Power3
                } of the AIU. `,
        },
    ];
