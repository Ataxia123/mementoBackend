...
export async function generateScannerOutput(metadata) {
    const messages = [
        {
            role: "system",
        ...
        },
        {
            ...
            GENERATING SCANNER OUTPUT FOR ${metadata.Level}${" "}${metadata.Power1}${" "}${metadata.Power2}${" "}${metadata.Power3} of the AIU. `,
        },
    ];
